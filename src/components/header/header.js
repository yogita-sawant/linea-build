            ...
            <nav className="navbar-container">
                ...
                <div id="navbar-menu" aria-labelledby="navbar-toggle">
                    <ul className="navbar-links">
                        <li className="navbar-item"><a className="navbar-link" href="/about"><div className='circle-icon'></div>Learn</a></li>
                        <li className="navbar-item"><a className="navbar-link" href="/blog"><div className='circle-icon'></div>Build</a></li>
                        <li className="navbar-item"><a className="navbar-link" href="/careers"><div className='circle-icon'></div>Ecosystem</a></li>
                        <li className="navbar-item"><a className="navbar-link" href="/contact"><div className='circle-icon'></div>Community</a></li>
                        <li className="navbar-item"><a className="navbar-link" href="/contact">Security</a></li>
                    </ul>
                </div>
            </nav>
        </header>
